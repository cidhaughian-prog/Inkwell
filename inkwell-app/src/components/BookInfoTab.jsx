...
export default function BookInfoTab({ book, onUpdate }) {
  return (
    <div className="card p-8 space-y-6">
      <p className="font-ui text-xs text-ink-600 opacity-60">Looking for colors, background, or fonts? Click the gear icon next to the title above — this tab is just the book's details.</p>
